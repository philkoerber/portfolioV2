...
function Web(props) {
  return (
    <div className="flex justify-center p-8 text-verydark">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.stack.map((tech, j) => (
                  <span
                    key={j}
                    className="bg-antique text-black text-xs px-2 py-1 rounded-full"
                  >
                    #{tech}
                  </span>
                ))}
              ...
              <a
                ...
                className="mt-4 right-0 inline-block bg-antique text-black text-sm font-semibold px-4 py-2 hover:bg-antique/80 transition duration-200 shadow-md"
              >
                Visit {project.title} →
              </a>
            </div>
